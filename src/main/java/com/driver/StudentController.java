...
public class StudentController {
    ...
    public ResponseEntity<String> addTeacher(@RequestBody Teacher teacher){
        return new ResponseEntity<>(studentService.addTeacher(teacher), HttpStatus.CREATED);
    }

    @PutMapping("/add-student-teacher-pair")
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        return new ResponseEntity<>(studentService.addStudentTeacherPair(student,teacher), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<String> deleteTeacherByName(@RequestParam String teacher){
        return new ResponseEntity<>(studentService.deleteTeacherByName(teacher), HttpStatus.CREATED);
    }
    @DeleteMapping("/delete-all-teachers")
    public ResponseEntity<String> deleteAllTeachers(){
        return new ResponseEntity<>(studentService.deleteAllTeachers(), HttpStatus.CREATED);
    }
}
